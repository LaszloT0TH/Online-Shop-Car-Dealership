...
namespace CarDealershipASPNETMVC.Models
{
    public class CarAccessoriesModel : IEntityStringBase
    {
        ...
        [ForeignKey("CAPGId")]
        public virtual CarAccessoriesProductGroupModel carAccessoriesProductGroupModel { get; set; }
        ...
        public virtual CarAccessoriesUnitModel carAccessoriesUnitModel { get; set; }
