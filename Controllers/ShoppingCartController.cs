...
namespace CarDealershipASPNETMVC.Controllers
{
    public class ShoppingCartController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> SaveForLaterView()
        {
        ...
        [HttpGet]
        public async Task<IActionResult> OrderedView()
        {
        ...
        [HttpGet]
        public async Task<IActionResult> InTransitView()
        {
        ...
        [HttpGet]
        public async Task<IActionResult> DeliveredView()
        {
